...
document.getElementById("skills").innerHTML = "<li>Angular</li> <li>Scrum</li><li>Scrum</li><li>Azure</li> <li>HTML, CSS and JavaScript</li> <li>Java and c#</li> <li>SQL</li> <li>Git</li><li>Web design and development</li> <li>Problem solving and logical thinking</li> <li>Teamworker</li> <li>Excellent interpersonal skills</li>";
