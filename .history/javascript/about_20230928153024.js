...
document.getElementById("skills").innerHTML = "<li>Angular</li> <li>React js</li><li>React Native</li><li>Java Swing</li> <li>HTML, CSS and JavaScript</li> <li>Java</li> <li>SQL</li> <li>Git</li><li>Nodejs</li> <li>Problem solving and logical thinking</li> <li>Teamworker</li> <li>Excellent interpersonal skills</li>";
